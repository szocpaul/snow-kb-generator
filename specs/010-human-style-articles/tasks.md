...
- [ ] T011 [US4] GEPA futás `max_metric_calls=200` (lokális task rollout + judge + Kimi K3 reflection; időkorlát ~1.5-2 óra, `-np 4` / `num_threads=4` — FR-004, 2026-08-08: slot-bővítés 2→4)
